...
<body>
  ...
  <div class="" style="padding-top: 50px;">
    <p>ডাউনলোডের সময়কালঃ {{ date('F d, Y, h:m:i A') }}</p>
  </div>

  {{-- <htmlpagefooter name="page-footer">
    <small style="font-family: Calibri; color: #6D6E6A;">Generated by: https://cvcsbd.com</small>
  </htmlpagefooter> --}}
  <p style="bottom: 10; position: absolute;"><small style="font-family: Calibri; color: #6D6E6A;">Generated by: https://cvcsbd.com</small></p>
</body>
</html>