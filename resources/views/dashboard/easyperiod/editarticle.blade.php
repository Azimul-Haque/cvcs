...
@section('title', 'EasyPeriod | Edit Article')
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="box box-primary" id="beforedivheightcommodity">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form action="{{ route('easyperiod.article.update', $article->id) }}" method="post" enctype='multipart/form-data'>
              {!! csrf_field() !!}
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                      <label for="title" class="text-uppercase">Title</label>
                      <input class="form-control" type="text" name="title" id="title" value="{{ $article->title }}" placeholder="Write Title" required="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                      <label for="publishing_date" class="text-uppercase">Author</label>
                      <input class="form-control" type="text" name="author" id="author" value="{{ $article->author }}" placeholder="Author Name" required="">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="category" id="category" value="{{ $article->category }}" placeholder="Write Category" required="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                      <label for="slug" class="text-uppercase">Slug</label>
                      <input class="form-control" type="text" name="slug" id="slug" value="{{ $article->slug }}"  placeholder="Write a Slug (e.g. this-is-a-post)" required="">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group no-margin-bottom">
                  ...
                  <textarea type="text" name="body" id="body" class="summernote" required="">{!! $article->body !!}</textarea>
              </div>
              <div class="row margin-three">
                ...
                <div class="col-md-4">
                  @if($article->featured_image != null && file_exists(public_path('images/easyperiod/articles/' . $article->featured_image)))
                    <img src="{{ asset('images/easyperiod/articles/' . $article->featured_image)}}" id='img-upload' style="height: 200px; width: auto; padding: 5px;" class="img-responsive"/>
                  @else
