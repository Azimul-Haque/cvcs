              ...
              <div class="modal fade" id="sendToDefectiveListModal{{ $member->id }}" role="dialog">
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    ...
                    {!! Form::model($member, ['route' => ['dashboard.transfermember', $member->id], 'method' => 'PATCH', 'class' => 'form-default']) !!}
                    <div class="modal-body">
                      ...
                      <div class="checkbox">
                        <label><input type="checkbox" name="confirmcheckbox" value="" required>আপনি কি নিশ্চিতভাবে দপ্তর পরিবর্তন করতে চান? (চেক বাটনে ক্লিক করুন)</label>
                      </div>
                    </div>
