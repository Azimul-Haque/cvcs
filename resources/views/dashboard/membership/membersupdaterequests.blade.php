    ...
    <table class="table table-bordered" id="mainTable">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $tempmemdata->user->branch->name }}<br/>{{ $tempmemdata->user->profession }} ({{ $tempmemdata->user->position->name }})</td>
          <td>
          ...
          <td>
            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#approveData{{ $tempmemdata->id }}" data-backdrop="static" title="তথ্য যাচাই ও অনুমোদন করুন"><i class="fa fa-check"></i></button>
            <!-- Approve Data Modal -->
            <!-- Approve Data Modal -->
            ...
            <!-- Approve Data Modal -->
            <!-- Approve Data Modal -->
            <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteTempMemData{{ $tempmemdata->id }}" data-backdrop="static" title="অনুরোধটি ডিলেট করুন"><i class="fa fa-trash-o"></i></button>
