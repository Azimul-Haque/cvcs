        ...
        <div class="panel panel-default">
          <div class="panel-body">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="gender" id="gender" class="text_bangla form-control" required="">
                        ...
                        <option value="নারী" @if($application->gender == 'নারী') selected="" @endif>নারী</option>
                        <option value="পুরুষ" @if($application->gender == 'পুরুষ') selected="" @endif>পুরুষ</option>
                        <option value="অন্যান্য" @if($application->gender == 'অন্যান্য') selected="" @endif>অন্যান্য</option>
                    </select>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <input value="{{ $application->spouse }}" type="text" name="spouse" id="spouse" class="text_bangla form-control" placeholder="স্বামী/স্ত্রীর নাম বাংলায় লিখুন">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <input value="{{ $application->spouse_profession }}" type="text" name="spouse_profession" id="spouse_profession" class="text_bangla form-control" placeholder="স্বামী/স্ত্রীর পেশা বাংলায় লিখুন">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group ">
                    <label for="father" class="">পিতার নাম *</label>
                    <input value="{{ $application->father }}" type="text" name="father" id="father" required="" class="text_bangla form-control" placeholder="পিতার নাম বাংলায় লিখুন">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <input value="{{ $application->mother }}" type="text" name="mother" id="mother" required="" class="text_bangla form-control" placeholder="মাতার নাম বাংলায় লিখুন">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group ">
            ...
            <div class="form-group ">
                ...
                <input value="{{ $application->present_address }}" type="text" name="present_address" id="present_address" required="" class="text_bangla form-control" placeholder="বাংলায় লিখুন">
            </div>
            <div class="form-group ">
                <label for="permanent_address" class="">স্থায়ী ঠিকানা</label>
                <input value="{{ $application->permanent_address }}" type="text" name="permanent_address" id="permanent_address" class="text_bangla form-control" required="" placeholder="বাংলায় লিখুন">
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group ">
                    <label for="office_telephone" class="">অফিসের টেলিফোন (ঐচ্ছিক)</label>
                    <input value="{{ $application->office_telephone }}" class="form-control" type="number" name="office_telephone" id="office_telephone" placeholder="অফিসের টেলিফোন নম্বর ইংরেজি লিখুন">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group ">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <input value="{{ $application->home_telephone }}" class="form-control" type="number" name="home_telephone" id="home_telephone" placeholder="বাসার টেলিফোন নম্বর ইংরেজিতে লিখুন">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group ">
                    <label for="email" class="">ইমেইল এড্রেস <small>(ইমেইল না থাকলে ফাঁকা রাখুন)</small></label>
                    <input value="{{ $application->email }}" class="form-control" type="email" name="email" id="email" autocomplete="off" placeholder="একটি ভ্যালিড ইমেইল এড্রেস লিখুন">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-4">
                <img src="{{ asset('images/users/'. $application->image)}}" id='img-upload' style="height: 120px; width: auto; padding: 5px;" />
              </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <input value="{{ $application->nominee_one_name }}" type="text" name="nominee_one_name" id="nominee_one_name" required="" class="text_bangla form-control" placeholder="বাংলা বর্ণমালায় লিখুন">
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    <label for="nominee_one_identity_type" class="">দলিলের ধরণ</label>
                    <select class="form-control" name="nominee_one_identity_type" id="nominee_one_identity_type" required="">
                        <option value="" selected="" disabled="">দলিলের ধরণ নির্ধারণ করুন</option>
                        <option value="0" @if($application->nominee_one_identity_type == 0) selected="" @endif>জাতীয় পরিচয়পত্র</option>
                        <option value="1" @if($application->nominee_one_identity_type == 1) selected="" @endif>জন্ম নিবন্ধন</option>
                    </select>
                </div>
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input value="{{ $application->nominee_one_relation }}" type="text" name="nominee_one_relation" id="nominee_one_relation" class="text_bangla form-control" required="" placeholder="সম্পর্ক লিখুন">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                    <label for="nominee_one_percentage" class="">শতকরা হার (%) *</label>
                    <input value="{{ $application->nominee_one_percentage }}" class="form-control" type="number" min="1" max="100" minlength="1" maxlength="3" name="nominee_one_percentage" id="nominee_one_percentage" required="" placeholder="ইংরেজি অংকে লিখুন">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-8">
                  <div class="form-group">
                      ...
                      <input value="" class="form-control" type="file" id="nominee_one_image" name="nominee_one_image">
                  </div>
              </div>
              <div class="col-md-4">
                <img src="{{ asset('images/users/'. $application->nominee_one_image)}}" id='nominee_one_image-upload' style="height: 120px; width: auto; padding: 5px;" />
              </div>
            </div>
                  ...
                  <div id="collapse-nominee2-link1" class="panel-collapse collapse @if($application->nominee_two_name != '') in @else @endif">
                      <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ $application->nominee_two_name }}" type="text" name="nominee_two_name" id="nominee_two_name" class="text_bangla form-control" placeholder="বাংলা বর্ণমালায় লিখুন">
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="nominee_two_identity_type" class="">দলিলের ধরণ</label>
                                <select class="form-control" name="nominee_two_identity_type" id="nominee_two_identity_type">
                                    <option value="" selected="" disabled="">দলিলের ধরণ নির্ধারণ করুন</option>
                                    <option value="0" @if($application->nominee_two_identity_type == 0) selected="" @endif>জাতীয় পরিচয়পত্র</option>
                                    <option value="1" @if($application->nominee_two_identity_type == 1) selected="" @endif>জন্ম নিবন্ধন</option>
                                </select>
                            </div>
                          </div>
                          <div class="col-md-6">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $application->nominee_two_relation }}" type="text" name="nominee_two_relation" id="nominee_two_relation" class="text_bangla form-control form-control" placeholder="সম্পর্ক লিখুন">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="nominee_two_percentage" class="">শতকরা হার (%)</label>
                                <input value="{{ $application->nominee_two_percentage }}" class="form-control" type="number" min="1" max="100" minlength="1" maxlength="3" name="nominee_two_percentage" id="nominee_two_percentage" placeholder="ইংরেজি অংকে লিখুন">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-8">
                              <div class="form-group">
                                  <label><strong>নমিনির রঙিন ছবি (৩০০x৩০০ এবং সর্বোচ্চ ২৫০ কিলোবাইট)</strong></label>
                                  <input value="" class="form-control" type="file" id="nominee_two_image" name="nominee_two_image">
                              </div>
                          </div>
                          <div class="col-md-4">
                            <img src="@if($application->nominee_two_image != '') {{ asset('images/users/' .$application->nominee_two_image)}} @else {{ asset('images/user.png')}} @endif" id='nominee_two_image-upload' style="height: 120px; width: auto; padding: 5px;" />
                          </div>
                        </div> 
                      </div>
                  </div>
