...
@section('title', 'CVCS | একাধিক পরিশোধকারী নির্ধারণ')
    ...
    <div class="col-md-6">
      <div class="box box-primary">
        <div class="box-header with-border text-blue">
          ...
          <h3 class="box-title">একাধিক পরিশোধকারী সিলেক্ট করুন</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          {!! Form::open(['route' => 'dashboard.addbulkpayer', 'method' => 'POST']) !!}
            ...
            <div class="form-group">
              <button class="btn btn-success" type="submit"><i class="fa fa-user-secret"></i> একাধিক পরিশোধকারী নিয়োগ দিন</button>
            </div>
          {!! Form::close() !!}
        </div>
        <!-- /.box-body -->
...
@section('js')
  <script type="text/javascript">
    setTimeout(function() {
      $.ajax({
          url: '{{ url('/dashboard/bulk/payers/search') }}',
          type: 'GET',
