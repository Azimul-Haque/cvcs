...
@section('content_header')
    <h1>
      ...
      <div class="pull-right">
        ...
        <button class="btn btn-success" href="#!" title="দপ্তর যোগ করুন (কাজ চলছে...)" data-toggle="modal" data-target="#addBranchModal" data-backdrop="static" title="নতুন ব্রাঞ্চ যোগ করুন" data-placement="top"><i class="fa fa-fw fa-plus" aria-hidden="true"></i></button> {{-- {{ route('dashboard.createbulkpayer') }} --}}
        @endif
      </div>
    </h1>
@stop
                  ...
                  {!! Form::model($branch, ['route' => ['dashboard.updatebranch', $branch->id], 'method' => 'PUT', 'class' => 'form-default']) !!}
                    <div class="modal-body">
                      <div class="form-group">
                        ...
                        {!! Form::text('name', $branch->name, array('class' => 'form-control', 'id' => 'name', 'placeholder' => 'কাস্টমস অফিসের নাম', 'required' => '')) !!}
                      </div>
                      <div class="form-group">
