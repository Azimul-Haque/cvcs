      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addBranchPaymentModal" data-backdrop="static" title="নতুন বিল অব এন্ট্রি পরিশোধ যোগ করুন" data-placement="top"><i class="fa fa-plus"></i> নতুন বিল অব এন্ট্রি </button>
          </div>
        </div>
