...
@section('title', 'CVCS | Archived Form Messages')
...
@section('content_header')
    <h1>
      যোগাযোগ ফর্মের বার্তাসমূহ (আর্কাইভ)
      ...
      <table class="table table-bordered table-condensed">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteFormMessageModal{{ $message->id }}" data-backdrop="static" title="মেসেজ ডিলেট করুন"><i class="fa fa-trash-o"></i></button>
