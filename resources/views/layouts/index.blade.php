        ...
        <div class="container footer-middle">
            <div class="row">
                <div class="col-md-4 col-sm-4 footer-link1 xs-display-none">
                    ...
                    <!-- end headline -->
                    <!-- text -->
                    <p class="footer-text">কাস্টমস এন্ড ভ্যাট কো অপারেটিভ সোসাইটি (সিভিসিএস) লিমিটেড</p>
                    <!-- end text -->
                </div>
            ...
            <div class="container">
                <div class="row margin-three">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 copyright text-left letter-spacing-1 xs-text-center xs-margin-bottom-one">
                        &copy; {{ date('Y') }} CVCS. Developed by <a href="https://innovatechbd.net" style="color: #ffffff;" target="_blank">InnovaTech Bangladesh</a>
                    </div>
                    <!-- end copyright -->
                    <!-- logo -->
