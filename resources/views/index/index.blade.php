        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-sm-10 text-center center-col">
                    ...
                    <h1>কাস্টমস এন্ড ভ্যাট কো অপারেটিভ সোসাইটি (সিভিসিএস) লিমিটেড</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 col-sm-12 text-center center-col">
                    ...
                    <a href="{{ route('index.application') }}" class="highlight-button-royal-blue-border btn margin-six wow fadeInUp">আবেদন করুন!</a><br/><br/><br/>
