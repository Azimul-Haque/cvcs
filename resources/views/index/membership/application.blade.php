...
@section('content')
    <form action="{{ route('index.storeapplication') }}" id="application_form" method="post"
          enctype='multipart/form-data' data-parsley-validate="">
        <section class="wow fadeIn bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-sm-10 col-xs-11 center-col login-box xs-margin-top-twelve margin-bottom"
                         id="presubmission_div">
                        <h2 class="agency-title margin-two">
                            আবেদন করার আগে...
                        </h2>
                        <ul>
                            <li><i class="fa fa-check-square-o"></i> আপনার নিজের অত্যাবশ্যক তথ্যগুলো একত্র করুন</li>
                            <li><i class="fa fa-check-square-o"></i> আপনার নিজের এক কপি ৩০০x৩০০ সাইজের রঙিন ছবির সফট/
                                স্ক্যান কপি প্রস্তুত রাখুন
                            </li>
                            <li><i class="fa fa-check-square-o"></i> দুজন নমিনির ৩০০x৩০০ সাইজের রঙিন ছবির সফট/ স্ক্যান
                                কপি প্রস্তুত রাখুন
                            </li>
                            <li><i class="fa fa-check-square-o"></i> মেম্বারশিপ ফি বাবদ ৫০০০ টাকার ব্যাংক ডিপোজিট
                                রিসিটটির সফট/ স্ক্যান কপি প্রস্তুত রাখুন
                            </li>
                            <li><i class="fa fa-check-square-o"></i> <b>মোবাইল নম্বর</b> ঘরে ১১ ডিজিটের সক্রিয় একটি
                                নম্বর দিন; এ নম্বরেই যাবতীয় তথ্য SMS আকারে পাঠানো হবে
                            </li>
                            <li><i class="fa fa-check-square-o"></i> নমিনি একজন হলে শতকরা হার ঘরের মান 100 রাখুন</li>
                            <li><i class="fa fa-check-square-o"></i> নমিনি দুইজন হলে দুই নমিনির শতকরা হারের যোগফল যেন
                                100 হয় সেদিকে খেয়াল রাখুন
                            </li>
                        </ul>
                        <button type="button" class="btn highlight-button-royal-blue btn-bg no-margin-right"
                                id="presubmission_info">ঠিক আছে
                        </button>
                    </div>
                    <div class="col-md-10 col-sm-10 col-xs-11 center-col login-box xs-margin-top-twelve">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="name_bangla" id="name_bangla" class="text_bangla"
                                           required="" data-parsley-required-message="আবেদনকারীর নাম বাংলায় লিখুন"
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="name" id="name" required=""
                                           placeholder="ইংরেজি বর্ণমালায় নাম লিখুন">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="number" onKeyPress="if(this.value.length==17) return false;" name="nid"
                                           id="nid" required="" placeholder="ইংরেজি অংকে পরিচয়পত্র নম্বরটি লিখুন">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group ">
                                    <label for="dob" class="">জন্মতারিখ *</label>
                                    <input type="text" name="dob" id="dob" data-field="date" autocomplete="off"
                                           required="" placeholder="জন্মতারিখ নির্ধারণ করুন">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="spouse" id="spouse" class="text_bangla"
                                           placeholder="স্বামী/স্ত্রীর নাম বাংলায় লিখুন">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="spouse_profession" id="spouse_profession"
                                           class="text_bangla" placeholder="স্বামী/স্ত্রীর পেশা বাংলায় লিখুন">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group ">
                                    <label for="father" class="">পিতার নাম *</label>
                                    <input type="text" name="father" id="father" required="" class="text_bangla"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="mother" id="mother" required="" class="text_bangla"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="profession" id="profession" required="" class="text_bangla"
                        ...
                        <div class="form-group ">
                            <label for="joining_date" class="">চাকুরীতে যোগদানের তারিখ <b>(তথ্য না থাকলে ফাঁকা
                                    রাখুন)</b></label>
                            <input type="text" name="joining_date" id="joining_date" data-field="date"
                                   autocomplete="off" placeholder="চাকুরীতে যোগদানের তারিখ">
                        </div>
                        <div class="form-group ">
                            <label for="prl_date" class="">চাকুরি থেকে অবসর গ্রহণের তারিখ <b>(তথ্য না থাকলে ফাঁকা
                                    রাখুন)</b></label>
                            <input type="text" name="prl_date" id="prl_date" data-field="date" autocomplete="off"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="number" name="office_telephone" id="office_telephone"
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="number" onKeyPress="if(this.value.length==11) return false;"
                                           ...
                                           placeholder="ইংরেজি অংকে লিখুন (১১ ডিজিট)">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="email" name="email" id="email" autocomplete="off"
                                           placeholder="একটি ভ্যালিড ইমেইল এড্রেস লিখুন">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group ">
                                    <label><strong>আবেদনকারীর রঙিন ছবি (৩০০x৩০০ এবং সর্বোচ্চ ২৫০
                        ...
                        <h3 class="agency-title margin-two">নমিনীর বিস্তারিত তথ্যঃ (নমিনি ০১) <small>(নমিনির তথ্য নমিনি
                                ০১ এর ক্ষেত্রে বাধ্যতামূলক)</small></h3>

                        <div class="form-group ">
                            <label for="nominee_one_name" class="">নাম (বাংলায়) *</label>
                            <input type="text" name="nominee_one_name" id="nominee_one_name" required=""
                                   class="text_bangla" placeholder="বাংলা বর্ণমালায় লিখুন">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nominee_one_identity_type" class="">দলিলের ধরণ</label>
                                    <select name="nominee_one_identity_type" id="nominee_one_identity_type"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nominee_one_identity_text" class="">জাতীয় পরিচয়পত্র/ জন্ম নিবন্ধন নম্বর
                                        *</label>
                                    <input type="number" onKeyPress="if(this.value.length==17) return false;"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee_one_relation" id="nominee_one_relation"
                                           class="text_bangla" required="" placeholder="সম্পর্ক লিখুন">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nominee_one_percentage" class="">শতকরা হার (%) *</label>
                                    <input type="number" min="1" max="100" minlength="1" maxlength="3"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label><strong>নমিনির রঙিন ছবি (৩০০x৩০০ এবং সর্বোচ্চ ২৫০ কিলোবাইট)
                                            *</strong></label>
                                    <input type="file" id="nominee_one_image" name="nominee_one_image" required="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('images/user.png')}}" id='nominee_one_image-upload'
                                     style="height: 120px; width: auto; padding: 5px;"/>
                            </div>
                        </div>
                                ...
                                <div id="collapse-nominee2-link1" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="nominee_two_identity_type" class="form-control"
                                                            id="nominee_two_identity_type">
                                                        <option value="" selected="" disabled="">দলিলের ধরণ নির্ধারণ
                                                            করুন
                                                        </option>
                                                        <option value="0">জাতীয় পরিচয়পত্র</option>
                                                        <option value="1">জন্ম নিবন্ধন</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="nominee_two_identity_text" class="">জাতীয় পরিচয়পত্র/
                                                        জন্ম নিবন্ধন নম্বর</label>
                                                    <input type="number"
                                                           onKeyPress="if(this.value.length==17) return false;"
                                                           name="nominee_two_identity_text"
                                                           id="nominee_two_identity_text"
                                                           placeholder="ইংরেজি অংকে লিখুন">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nominee_two_relation"
                                                           id="nominee_two_relation" class="text_bangla"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="1" max="100" minlength="1" maxlength="3"
                                                           name="nominee_two_percentage" id="nominee_two_percentage"
                                                           placeholder="ইংরেজি অংকে লিখুন">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <img src="{{ asset('images/user.png')}}" id='nominee_two_image-upload'
                                                     style="height: 120px; width: auto; padding: 5px;"/>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group ">
                                    ...
                                    <input type="file" id="application_payment_receipt"
                                           name="application_payment_receipt" required="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('images/800x500.png')}}" id='application_payment_receipt-upload'
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="{{ asset('images/800x500.png')}}" id='application_hard_copy-upload'
                                     style="width: 250px; height: auto; padding: 5px;"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="{{ asset('images/800x500.png')}}" id='digital_signature-upload' style="width: 250px; height: auto; padding: 5px;" />
                            </div>
                        </div>
                        ...
                        <button type="button" class="btn highlight-button-royal-blue btn-bg margin-five no-margin-right"
                                data-toggle="modal" data-target="#submitApplicationModal" data-backdrop="static">আবেদন
                            জমা দিন
                        </button>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-check-square-o"></i> নম্বর সংক্রান্ত তথ্যগুলো (যেমনঃ মোবাইল নম্বর,
                                পরিচয়পত্র নম্বর, শতকরা হার ইত্যাদি <b>ইংরেজি অংকে (0,1,3,4...)</b> দিয়েছেন কি না যাচাই
                                করুন)
                            </li>
                            <li><i class="fa fa-check-square-o"></i> নমিনি একজন হলে শতকরা হার ঘরের মান 100 রাখুন</li>
                            <li><i class="fa fa-check-square-o"></i> নমিনি দুইজন হলে দুই নমিনির শতকরা হারের যোগফল যেন
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn highlight-button-royal-blue btn-bg margin-five no-margin-right"
                                type="submit" id="submit_btn">আবেদন জমা দিন
                        </button>
                        <button type="button" class="btn highlight-button btn-bg margin-five no-margin-right"
                                data-dismiss="modal">ফিরে যান
                        </button>
                    </div>
                </div>
            </div>
