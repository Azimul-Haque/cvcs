                                                ...
                                                <li>
                                                    ...
                                                    <ul class="menu">
                                                        @if($notifpendingapplications > 0)
                                                            <li>
                                                                <a href="{{ route('dashboard.applications') }}">
                                                                    <i class="fa fa-users text-aqua"></i> {{ $notifpendingapplications }}
                                                                    জন নিবন্ধন আবেদন করেছেন
                                                                </a>
                                                            </li>
                                                        @endif
                                                        ...
                                                        @if($notifdefectiveapplications > 0)
                                                            <li>
                                                                <a href="{{ route('dashboard.defectiveapplications') }}">
                                                                    <i class="fa fa-exclamation-triangle text-maroon"></i> {{ $notifdefectiveapplications }}
                                                                    টি অসম্পূর্ণ আবেদন আছে
                                                                </a>
                                                            </li>
                                                        @endif
                                                        ...
                                                        @if($notifpendingpayments > 0)
                                                            <li>
                                                                <a href="{{ route('dashboard.memberspendingpayments') }}">
                                                                    <i class="fa fa-hourglass-start text-yellow"></i> {{ $notifpendingpayments }}
                                                                    টি প্রক্রিয়াধীন পরিশোধ রয়েছে
                                                                </a>
                                                            </li>
                                                        @endif
                                                        ...
                                                        @if($notiftempmemdatas > 0)
                                                            <li>
                                                                <a href="{{ route('dashboard.membersupdaterequests') }}">
                                                                    <i class="fa fa-pencil-square-o text-green"></i> {{ $notiftempmemdatas }}
                                                                    টি তথ্য হালনাগাদ অনুরোধ
                                                                </a>
                                                            </li>
                                                        @endif
                                                        ...
                                                        @if($notifsmsbalance > 0 && $notifsmsbalance < 21)
                                                            <li>
                                                                <a href="#">
                                                                    <i class="fa fa-envelope-o text-red"></i> অপর্যাপ্ত
                                                                    SMS ব্যালেন্সঃ ৳ {{ $notifsmsbalance }}
                                                                </a>
                                                            </li>
                                                        @endif
                                                    </ul>
                                                </li>
                                                <li class="footer"><a href="{{ route('dashboard.notifications') }}">সব
                                                        দেখুন</a></li>
                                            </ul>
                                        </li>
                                        @else
                                            ...
                                            <li class="dropdown notifications-menu">
                                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                                   aria-expanded="true">
                                                    <i class="fa fa-bell-o"></i>
                                                    <span class="label label-warning">{{ ($missingFieldCount > 0)? 1: "" }}</span>
                                                </a>
                                                <ul class="dropdown-menu">
                                                    @if($missingFieldCount > 0)
                                                        <li class="header">{{ 1 }} টি নোটিফিকেশন আছে</li>
                                                    @else
                                                        <li class="header">কোন নোটিফিকেশন নেই!</li>
                                                    @endif
                                                            ...
                                                            @if($missingFieldCount > 0)
                                                                <li>
                                                                    <a href="{{ route('dashboard.profile') }}">
                                                                        <i class="fa fa-users text-aqua"></i> {{ $missingFieldCount }}
                                                                        টি তথ্য প্রদান বাকি আছে
                                                                    </a>
                                                                </li>
                                                            @endif
                                                            <li class="footer"></li>
                                               ...
                                               aria-expanded="true">
                                                @if((Auth::User()->image != '') && (file_exists(public_path('images/users/'.Auth::User()->image))))
                                                    <img src="{{ asset('images/users/'.Auth::User()->image)}}"
                                                         class="user-image"
                                                         alt="{{ Auth::User()->name_bangla }}-এর মুখছবি">
                                                @else
                                                    ...
                                                    <div class="pull-left">
                                                        <a href="{{ route('dashboard.profile') }}"
                                                           class="btn btn-default btn-flat"><i
                                                                    class="fa fa-fw fa-user-o"></i> প্রোফাইল</a>
                                                    </div>
                        ...
                        @if(Auth::user()->role == 'admin')
                              ...
                              <i class="fa fa-angle-left pull-right"></i>
                                ...
                                <ul class="treeview-menu">
                                    @if((Auth::user()->role_type == 'admin') && (Auth::user()->email != 'dataentry@cvcsbd.com'))
                                        <li class="{{ Request::is('dashboard/admins') ? 'active' : '' }} {{ Request::is('dashboard/admins/create') ? 'active' : '' }}">
                                            <a href="{{ route('dashboard.admins') }}"><i
                                                        class="fa fa-user-secret text-aqua"></i> অ্যাডমিনগণ</a></li>
                                        <li class="{{ Request::is('dashboard/bulk/payers') ? 'active' : '' }} {{ Request::is('dashboard/bulk/payers/create') ? 'active' : '' }}">
                                            <a href="{{ route('dashboard.bulkpayers') }}"><i
                                                        class="fa fa-users text-yellow"></i> একাধিক পরিশোধকারীগণ</a>
                                        </li>
                                    @endif
                                    <li class="{{ Request::is('dashboard/donors') ? 'active' : '' }} {{ Request::is('dashboard/donor/*') ? 'active' : '' }}">
                                        <a href="{{ route('dashboard.donors') }}"><i
                                                    class="fa fa-trophy text-lightgreen"></i> ডোনেশন</a></li>
                                    <li class="{{ Request::is('dashboard/branches/payments') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.branches.payments') }}"><i
                                                    class="fa fa-list-ol text-green"></i> বিল অব এন্ট্রি</a></li>
                                    <li class="{{ Request::is('dashboard/branches') ? 'active' : '' }} {{ Request::is('dashboard/branch/*') ? 'active' : '' }}">
                                        <a href="{{ route('dashboard.branches') }}"><i class="fa fa-home text-aqua"></i>
                                            দপ্তর সমূহ</a></li>
                                    <li class="{{ Request::is('dashboard/designations') ? 'active' : '' }} {{ Request::is('dashboard/designation/*') ? 'active' : '' }}">
                                        <a href="{{ route('dashboard.designations') }}"><i
                                                    class="fa fa-id-card-o text-lightgreen"></i> পদবি সমূহ</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="{{ Request::is('dashboard/committee') ? 'active menu-open' : '' }} {{ Request::is('dashboard/abouts') ? 'active menu-open' : '' }} {{ Request::is('dashboard/gallery') ? 'active menu-open' : '' }} {{ Request::is('dashboard/gallery/*') ? 'active menu-open' : '' }} {{ Request::is('dashboard/events') ? 'active menu-open' : '' }} {{ Request::is('dashboard/notice') ? 'active menu-open' : '' }} {{ Request::is('dashboard/form/messages') ? 'active menu-open' : '' }} {{ Request::is('dashboard/slider') ? 'active menu-open' : '' }} {{ Request::is('dashboard/faq') ? 'active menu-open' : '' }} treeview">
                              ...
                              <i class="fa fa-angle-left pull-right"></i>
                                ...
                                <ul class="treeview-menu">
                                    <li class="{{ Request::is('dashboard/committee') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.committee') }}"><i class="fa fa-coffee"></i>
                                            কমিটি</a></li>
                                    <li class="{{ Request::is('dashboard/slider') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.slider') }}"><i class="fa fa-list-alt"></i>
                                            স্লাইডার</a></li>
                                    <li class="{{ Request::is('dashboard/abouts') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.abouts') }}"><i class="fa fa-pencil"></i> তথ্য
                                            এবং টেক্সট</a></li>
                                    <li class="{{ Request::is('dashboard/gallery') ? 'active' : '' }} {{ Request::is('dashboard/gallery/*') ? 'active' : '' }}">
                                        <a href="{{ route('dashboard.gallery') }}"><i class="fa fa-picture-o"></i>
                                            গ্যালারি</a></li>
                                    <li class="{{ Request::is('dashboard/events') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.events') }}"><i class="fa fa-bullhorn"></i>
                                            ইভেন্ট</a></li>
                                    <li class="{{ Request::is('dashboard/notice') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.notice') }}"><i class="fa fa-bell-o"></i>
                                            নোটিশ</a></li>
                                    <li class="{{ Request::is('dashboard/faq') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.faq') }}"><i
                                                    class="fa fa-question-circle-o"></i> FAQ</a></li>
                                    <li class="{{ Request::is('dashboard/form/messages') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.formmessage') }}"><i
                                                    class="fa fa-envelope-o"></i> ফরম মেসেজ</a></li>
                                </ul>
                            </li>
                        @endif
                        ...
                        @if((Auth::user()->role_type == 'admin') || (Auth::user()->role_type == 'manager') || (Auth::user()->role_type == 'bulkpayer'))
                            ...
                            <li class="{{ Request::is('dashboard/applications') ? 'active menu-open' : '' }} {{ Request::is('dashboard/defective/applications') ? 'active menu-open' : '' }} {{ Request::is('dashboard/application/*') ? 'active menu-open' : '' }} {{ Request::is('dashboard/member/*') ? 'active menu-open' : '' }} {{ Request::is('dashboard/members') ? 'active menu-open' : '' }} {{ Request::is('dashboard/members/payments/pending') ? 'active menu-open' : '' }} {{ Request::is('dashboard/members/payments/approved') ? 'active menu-open' : '' }} {{ Request::is('dashboard/members/update/requests') ? 'active menu-open' : '' }} treeview">
                              ...
                              <i class="fa fa-angle-left pull-right"></i>
                                ...
                                <ul class="treeview-menu">
                                    <li class="{{ Request::is('dashboard/applications') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.applications') }}"><i
                                                    class="fa fa-user-plus"></i> আবেদনসমূহ</a></li>
                                    <li class="{{ Request::is('dashboard/defective/applications') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.defectiveapplications') }}"><i
                                                    class="fa fa-exclamation-triangle"></i> অসম্পূর্ণ আবেদনসমূহ</a></li>
                                    <li class="{{ Request::is('dashboard/members') ? 'active' : '' }}"><a
                                                href="{{ route('dashboard.members') }}"><i
                                                    class="fa fa-users"></i><span> সদস্যগণ</span></a></li>
                                    @if(Auth::user()->role == 'admin')
                                        <li class="{{ Request::is('dashboard/members/payments/pending') ? 'active' : '' }}">
                                            <a href="{{ route('dashboard.memberspendingpayments') }}"><i
                                                        class="fa fa-hourglass-start"></i> প্রক্রিয়াধীন পরিশোধসমূহ</a>
                                        </li>
                                        <li class="{{ Request::is('dashboard/members/payments/approved') ? 'active' : '' }}">
                                            <a href="{{ route('dashboard.membersapprovedpayments') }}"><i
                                                        class="fa fa-check-square-o"></i> অনুমোদিত পরিশোধসমূহ</a></li>
                                        <li class="{{ Request::is('dashboard/members/update/requests') ? 'active' : '' }}">
                                            <a href="{{ route('dashboard.membersupdaterequests') }}"><i
                                                        class="fa fa-pencil-square"></i> তথ্য পরিবর্তন অনুরোধসমূহ</a>
                                        </li>
                                    @endif
                                </ul>
                            </li>
