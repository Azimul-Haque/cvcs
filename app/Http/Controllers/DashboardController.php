...
class DashboardController extends Controller
{
    ...
    public function paymentVerification()
    {
        ...
        foreach ($temppayments as $temppayment)
        {
            ...
            $api = "http://secure.aamarpay.com/api/v1/trxcheck/request.php?request_id=CVCS1613278705VDXQ6&store_id=cvcsbd&signature_key=4cde6ff3e7816ac461447af66baca194&type=json";
