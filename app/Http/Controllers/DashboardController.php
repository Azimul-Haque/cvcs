...
class DashboardController extends Controller
{
    ...
    public function testGPSMSAPI() 
    {
        ...
        $result = file_get_contents('https://gpcmp.grameenphone.com/gpcmpapi/messageplatform/controller.home?username=CAVCSAdmin_3978&password=API_CVCSbd_123&apicode=1&msisdn=01780507408,01751398392&countrycode=880&cli=CVCS&messagetype=1&message=Test&messageid=1');
        echo $result;
