...
Route::post('/dashboard/member/update/transfer/{id}', ['as'=>'dashboard.transfermember','uses'=>'DashboardController@transferMember']);
Route::post('/dashboard/member/update/designation/{id}', ['as'=>'dashboard.changedesignation','uses'=>'DashboardController@changeDesignation']);
...
Route::get('/dashboard/members/for/all/branch/{branch_id}', ['as'=>'dashboard.membersforall.branchwise','uses'=>'DashboardController@getMembersForAllBranchWise']);
...
Route::get('/dashboard/delete/double/payments', ['as'=>'dashboard.deldoubles','uses'=>'DashboardController@delDoublePayments']);
// operation
// operation
...
Route::get('/dashboard/excel/output/{start_id}/{end_id}', ['as'=>'dashboard.exceloutput','uses'=>'DashboardController@getExcelDataAll']);
// DB BACKUP
// DB BACKUP
